...
public class VentasController implements Serializable {
    ...
    private List<Ventas> itemsEliminados = null;
    private Ventas selected;

    public VentasController() {
    }

    public List<Ventas> getItemsEliminados() {
    ...
    public void setItemsEliminados(List<Ventas> itemsEliminados) {
    ...
    public List<Ventas> getItems() {
        if (items == null) {
            items = ejbFacade.consultarVentas();
        }
        return items;
    }
