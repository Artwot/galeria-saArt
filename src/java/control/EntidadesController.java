...
public class EntidadesController implements Serializable {
    ...
    private List<Entidades> itemsEliminados = null;
    private Entidades selected;

    public EntidadesController() {
    }

    public List<Entidades> getItemsEliminados() {
    ...
    public void setItemsEliminados(List<Entidades> itemsEliminados) {
    ...
    public List<Entidades> getItems() {
        if (items == null) {
            items = ejbFacade.consultarEntidades();
        }
        return items;
    }
