...
public class PaqueteriasFacade extends AbstractFacade<Paqueterias> {
    ...
    public List<Paqueterias> consultarPaqueterias() {
        Query consulta = em.createNamedQuery("Paqueterias.activos", Paqueterias.class);
    ...
    public List<Paqueterias> consultarEliminados() {
        Query consulta = em.createNamedQuery("Paqueterias.eliminados", Paqueterias.class);
        List<Paqueterias> lista = consulta.getResultList();
        if (!lista.isEmpty()) {
            return lista;
        } else {
