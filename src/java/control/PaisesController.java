...
public class PaisesController implements Serializable {
    ...
    private List<Paises> itemsEliminados = null;
    private Paises selected;

    public PaisesController() {
    }

    public List<Paises> getItemsEliminados() {
    ...
    public void setItemsEliminados(List<Paises> itemsEliminados) {
    ...
    public List<Paises> getItems() {
        if (items == null) {
            items = ejbFacade.consultarPaises();
        }
        return items;
    }
