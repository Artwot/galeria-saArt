...
public class DetalleVentaController implements Serializable {
    ...
    private List<DetalleVenta> itemsEliminados = null;
    private DetalleVenta selected;

    public DetalleVentaController() {
    }

    public List<DetalleVenta> getItemsEliminados() {
    ...
    public void setItemsEliminados(List<DetalleVenta> itemsEliminados) {
    ...
    public List<DetalleVenta> getItems() {
        if (items == null) {
            items = ejbFacade.consultarDetalleVenta();
        }
        return items;
    }
