...
public class EnviosFacade extends AbstractFacade<Envios> {
    ...
    {
        Query consulta= em.createNamedQuery("Envios.activos", Envios.class);
    ...
    public List<Envios> consultarEliminados()
    {
        Query consulta= em.createNamedQuery("Envios.eliminados", Envios.class);
        List<Envios> lista = consulta.getResultList();
        if(!lista.isEmpty())
            return lista;
        else
