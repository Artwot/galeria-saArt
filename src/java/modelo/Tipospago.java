...
@NamedQueries({
    ...
    , @NamedQuery(name = "Tipospago.activos", query = "SELECT t FROM Tipospago t WHERE t.status = 1")
    , @NamedQuery(name = "Tipospago.eliminados", query = "SELECT t FROM Tipospago t WHERE t.status = 0")
