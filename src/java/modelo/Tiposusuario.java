...
@NamedQueries({
    ...
    , @NamedQuery(name = "Tiposusuario.activos", query = "SELECT t FROM Tiposusuario t WHERE t.status = 1")
    , @NamedQuery(name = "Tiposusuario.eliminados", query = "SELECT t FROM Tiposusuario t WHERE t.status = 0")
