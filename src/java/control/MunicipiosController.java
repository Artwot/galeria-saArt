...
public class MunicipiosController implements Serializable {
    ...
    private List<Municipios> itemsEliminados = null;
    private Municipios selected;

    public MunicipiosController() {
    }

    public List<Municipios> getItemsEliminados() {
    ...
    public void setItemsEliminados(List<Municipios> itemsEliminados) {
    ...
    public List<Municipios> getItems() {
        if (items == null) {
            items = ejbFacade.consultarMunicipios();
        }
        return items;
    }
