...
public class TipospagoController implements Serializable {
    ...
    private List<Tipospago> itemsEliminados = null;
    private Tipospago selected;

    public TipospagoController() {
    }

    public List<Tipospago> getItemsEliminados() {
    ...
    public void setItemsEliminados(List<Tipospago> itemsEliminados) {
    ...
    public List<Tipospago> getItems() {
        if (items == null) {
            items = ejbFacade.consultarTipospago();
        }
        return items;
    }
